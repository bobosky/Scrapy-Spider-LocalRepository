...
class RequestByRequestsDownloadMiddleware(object):
    ...
    cookies = {
        'EEAkIjcBEarJg': settings['USERNAME'],
        'infopass': settings['PASSWORD'],
        'PHPSESSID': settings['PHPSESSID'],
        'myuniseqid': settings['MYUNISEQID']
    }
...
class DaohangwangSpiderMiddleware(object):
...
class DaohangwangDownloaderMiddleware(object):
    # Not all methods need to be defined. If a method is not defined,
